export default function Home() {
  ...
  600">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
                href="/works"
                className="rounded-md bg-slate-900 px-5 py-3 text-sm font-
  semibold text-white transition hover:bg-slate-700"
            >
              Worksを見る
            </a>
            <a
  ...
  text-sm font-semibold text-slate-900 transition hover:bg-white"
            >
              Blogを見る
            </a>
          </div>
